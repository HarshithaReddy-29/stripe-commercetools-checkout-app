...
exports.productTypeSubscription = exports.typeLineItem = exports.lineItemStripeSubscriptionErrorField = exports.lineItemStripeSubscriptionIdField = exports.lineItemProductSubscriptionIdField = exports.stripeCustomerIdCustomType = exports.stripeCustomerIdFieldName = exports.launchpadPurchaseOrderCustomType = void 0;
exports.launchpadPurchaseOrderCustomType = {
...
exports.stripeCustomerIdFieldName = 'stripeConnector_stripeCustomerId';
exports.stripeCustomerIdCustomType = {
    ...
    fieldDefinitions: [
        {
            ...
            name: exports.stripeCustomerIdFieldName,
            label: {
                en: 'Stripe Customer ID',
            },
            required: false,
...
exports.lineItemProductSubscriptionIdField = 'stripeConnector_productSubscriptionId';
exports.lineItemStripeSubscriptionIdField = 'stripeConnector_stripeSubscriptionId';
exports.lineItemStripeSubscriptionErrorField = 'stripeConnector_stripeSubscriptionError';
exports.typeLineItem = {
    ...
    fieldDefinitions: [
        {
            ...
            name: exports.lineItemProductSubscriptionIdField,
            label: {
        ...
        },
        {
            ...
            name: exports.lineItemStripeSubscriptionIdField,
            label: {
        ...
        },
        {
            ...
            name: exports.lineItemStripeSubscriptionErrorField,
            label: {
...
exports.productTypeSubscription = {
    ...
    attributes: [
        ...
        },
        {
            ...
            inputHint: 'SingleLine',
            inputTip: {
                'en-US': "Number of days a customer has to pay invoices generated by this subscription. Only applies when collection method is assigned as 'send_invoice'.",
            },
        },
        {
        ...
        },
        {
            ...
            inputHint: 'SingleLine',
            inputTip: {
                'en-US': 'The day of the month when the billing cycle should start. If a specific date time is needed, use the Billing Cycle Date field instead.',
            },
        },
        {
            ...
            inputTip: {
                'en-US': 'UTC Time of day to indicate when the billing cycle should start, this value works together with the Billing Cycle Anchor Day. If a specific date time is needed use the Billing Cycle Date field instead.',
            },
            type: {
                name: 'time',
            },
        ...
        },
        {
            ...
            inputHint: 'SingleLine',
            inputTip: {
                'en-US': 'Date and Time when trial should end (Displayed as Local Date Time), or define the amount of days in the Trial Period Days field.',
            },
        },
        {
